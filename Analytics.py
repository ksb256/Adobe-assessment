...
class Analytics:
    def __init__(self, input_file_location):
        ...
        self.spark = SparkSession.builder.master('yarn').appName('hit_list_analytics').getOrCreate()
        self.formatted_file_location = ''

    def format(self, input_file_location) -> str():
...
if __name__ == "__main__":
    ...
    formatted_file_location = obj.format(obj.input_file_location)
